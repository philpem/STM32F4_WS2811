...
ifneq ($(filter STM32F40_41xxx STM32F427_437xx STM32F429_439xx STM32F401xx,$(PLATFORM)),)
  ...
  CFLAGS	:=	-mthumb -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -fsingle-precision-constant -D__FPU_PRESENT=1 -D__FPU_USED=1
else
endif

# to write to flash then run
LDFLAGS+=-Wl,-T,vendor/ST/STM32-StdPeriph/Templates/STM32F4xx_StdPeriph_Templates/STM32F407IG_FLASH.ld
